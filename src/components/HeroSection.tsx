    ...
    <section className="relative w-full min-h-[60vh] flex flex-col items-center justify-center gap-6 py-8 sm:py-20 bg-gradient-to-br from-primary/10 via-purple-100 to-indigo-100 dark:from-primary/30 dark:via-primary/10 dark:to-background animate-fade-in px-2 sm:px-0">
      ...
      <div className="relative z-10 w-full max-w-xl mx-auto space-y-2 text-center">
        ...
        <div className="flex flex-col gap-1 items-center">
          <p className="max-w-xs xs:max-w-sm sm:max-w-2xl text-base md:text-xl text-muted-foreground drop-shadow-lg text-center">
            {t("hero.paragraph1")}
          </p>
          <p className="max-w-xs xs:max-w-sm sm:max-w-2xl text-base md:text-lg text-muted-foreground drop-shadow-lg text-center">
            {t("hero.paragraph2")}
          </p>
        </div>
